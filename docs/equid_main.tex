...
\begin{frontmatter}
  ...
  \fnref{2}}
   \ead{cmbd@uevora.pt} 
    ...
    \affiliation[Universidade de Lisboa]{Centro de Arqueologia da Universidade de Lisboa, Faculdade de Letras da Universidade de Lisboa, Alameda da Universidade, Lisboa, Portugal (1600-214)}
  ...
  \end{abstract}
    \begin{keyword}
    Peptide mass fingerprinting \sep Zooarchaeology \sep Palaeontology \sep Archaeology \sep 
    ZooMS
  \end{keyword}
...
\leavevmode\vadjust pre{\hypertarget{ref-peters_etal}{}}%
